...
rec {
  ...
  rootCrate = rec {
    packageId = "sticker-transformers 0.6.0 (path+file:///Users/daniel/git/sticker-transformers)";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "sticker-transformers 0.6.0 (path+file:///Users/daniel/git/sticker-transformers)" = rec {
