...
rec {
  ...
  rootCrate = rec {
    packageId = "sticker-transformers 0.5.0 (path+file:///Users/daniel/git/sticker-transformers)";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "backtrace 0.3.42 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
        crateName = "backtrace";
        version = "0.3.42";
        edition = "2018";
      ...
      "curl-sys 0.4.25 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
        crateName = "curl-sys";
        version = "0.4.25";
        edition = "2015";
      ...
      "miniz_oxide 0.3.5 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
      ...
      "openssl-sys 0.9.53 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
      ...
      "regex 1.3.3 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
        crateName = "regex";
        version = "1.3.3";
        edition = "2015";
      ...
      "regex-syntax 0.6.13 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
      ...
      "sticker-transformers 0.5.0 (path+file:///Users/daniel/git/sticker-transformers)" = rec {
      ...
      "tch 0.1.6 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
        crateName = "tch";
        version = "0.1.6";
        edition = "2018";
      ...
      "torch-sys 0.1.6 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
        crateName = "torch-sys";
        version = "0.1.6";
        edition = "2018";
